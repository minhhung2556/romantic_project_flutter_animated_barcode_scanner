...
class Detector {
  ...
  PerspectiveTransform createTransform(
    Offset topLeft,
    Offset topRight,
    Offset bottomLeft,
    ...
    computedDimension =
        computeDimension(topLeft, topRight, bottomLeft, calculateModuleSize(topLeft, topRight, bottomLeft));
  ...
  PerspectiveTransform createTransformCorners(
    Offset topLeft,
    Offset topRight,
    Offset bottomLeft,
    Offset alignmentPattern,
  ...
  PerspectiveTransform createInverseTransform(
    Offset topLeft,
    Offset topRight,
    Offset bottomLeft,
    Offset alignmentPattern,
  ...
  int computeDimension(Offset topLeft, Offset topRight, Offset bottomLeft, double moduleSize) {
  ...
  double calculateModuleSize(Offset topLeft, Offset topRight, Offset bottomLeft) {
    // Take the average
    return (calculateModuleSizeOneWay(topLeft, topRight) + calculateModuleSizeOneWay(topLeft, bottomLeft)) / 2.0;
  }
  ...
  double calculateModuleSizeOneWay(Offset pattern, Offset otherPattern) {
    final double moduleSizeEst1 = sizeOfBlackWhiteBlackRunBothWays(
        pattern.dx.toInt(), pattern.dy.toInt(), otherPattern.dx.toInt(), otherPattern.dy.toInt());
    final double moduleSizeEst2 = sizeOfBlackWhiteBlackRunBothWays(
        otherPattern.dx.toInt(), otherPattern.dy.toInt(), pattern.dx.toInt(), pattern.dy.toInt());
