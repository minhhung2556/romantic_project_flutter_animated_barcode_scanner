...
class AnimatedQRView extends StatefulWidget {
  const AnimatedQRView({
    ...
    required this.onScanBeforeAnimation,
    required this.animationDuration,
    required this.squareBorderColor,
...
*/
  ...
  void startHighlightQR() {
    final PerspectiveTransform transform = detector.createTransform(resultPointsPreviewFramingRect[1],
        resultPointsPreviewFramingRect[2], resultPointsPreviewFramingRect[0], resultPointsPreviewFramingRect[3]);
    ...
    final Size scaledSize =
        Size(viewfinderRect.right - viewfinderRect.left, viewfinderRect.bottom - viewfinderRect.top);
    ...
    final List<Offset> qrCornerScaled = [
      for (int i = 0; i < qrCornersPreview.length; i++)
        Offset(
    ...
    final Size centerCroppedSize = previewSize.width / previewSize.height < viewFinderSize.width / viewFinderSize.height
        ? Size(
            scaledSize.width,
    ...
    final List<Offset> qrCornerCenterCropped = [
      for (int i = 0; i < qrCornerScaled.length; i++)
        Offset(
